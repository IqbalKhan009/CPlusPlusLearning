...
int main(){
    ...
    cout<< "there was a virus called "  << virusname <<  " virus\n";
    ...
    cout<< virusname[0]<< " caused very financial problems in Pakistan\n";

    cout<<"the PM of Pakistan in " <<year<< " was  imran khan\n";
